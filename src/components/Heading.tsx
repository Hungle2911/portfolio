  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <p className="text-2xl font-mono mt-8">
        ...
        challenges. My goal is to contribute to innovative solutions that make a
        positive impact on society, whether through improving healthcare
        systems, enhancing environmental sustainability, or increasing access to
